...
public final class ObjectNode extends Node implements Iterable<String>{
    ...
    public Node get(String name){
        ...
        return this.objekti.get(name);
    }
    
    /**
     * Stores a name - JSON node pair into this JSON object. If a name-node pair with the same name already exists, the
     * previously existing node will be replaced.
    ...
    public void set(String name, Node node){
        this.objekti.put(name, node);
    }
    

    /**
     *
     * Returns a String iterator that iterates the names of the
     * name-node pairs stored in this JSON object in natural String
     * order.
